...
const App = ({ children, location, dispatch, app, loading }) => {
  ...
  const updatePassword = () => {
    ...
    dispatch({ type: 'app/changePassword', payload: { password: passwd.value, name: app.user.name, uid: app.user.uid, callback: (data) => {
  ...
  return (
    <div>
      ...
      {login
        ...
        <Modal visible={app.passwordModalVisible}
