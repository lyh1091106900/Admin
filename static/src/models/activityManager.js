import { query, remove, update, removeTable } from '../services/activityManager'
...
export default {
  ...
  effects: {
    *loadActivity({ payload }, { call, put }) {
      console.log('activityManager',payload)
    ...
    *removeActivity({ payload }, { call, put }) {
      console.log('removeactivityManager')
      yield put({ type: 'showLoading' });
    ...
    *updateActivity({ payload }, { call, put }) {
      console.log('updateactivityManager',payload)
      yield put({ type: 'showLoading' });
