import { query, remove, update, removeTable } from '../services/gamesDetailQuery'

export default {

  namespace: 'gamesDetailQuery',
  ...
  effects: {
    *loadGamesDetail({ payload }, { call, put }) {
    ...
    *removeGamesDetail({ payload }, { call, put }) {
    ...
    *updateGamesDetail({ payload }, { call, put }) {
  ...
  reducers: {
    ...
    loadGamesDetailSuccess(state, action) {
